...
export default function PostCard() {
  ...
  return generalData.top_posts.map((obj, index) => (
    <div key={index} className="shadow-sm mb-4 p-4 space-y-2">
      <Link
      ...
      >
        ...
        <div className="flex flex-col justify-center">
          ...
          <p className="text-gray-600 text-sm font-normal leading-normal line-clamp-2">
            <RelativeTime datetime={obj.product_created_at} />
          </p>
        </div>
      </Link>
